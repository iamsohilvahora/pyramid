...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \UpsFreeVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\UpsFreeVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \UpsFreeVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\UpsFreeVendor\Symfony\Component\Console\Output\OutputInterface $output, \UpsFreeVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\UpsFreeVendor\Symfony\Component\Console\Output\OutputInterface $output, \UpsFreeVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \UpsFreeVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param Configuration   $configuration
     */
    private function installPlugin($plugin_dir, \UpsFreeVendor\Symfony\Component\Console\Output\OutputInterface $output, \UpsFreeVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \UpsFreeVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\UpsFreeVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \UpsFreeVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
