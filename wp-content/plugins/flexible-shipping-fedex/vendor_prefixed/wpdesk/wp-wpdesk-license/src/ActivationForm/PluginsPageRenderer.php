 ...
 */
class PluginsPageRenderer implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
    ...
    public function output_render(string $plugin_file)
    {
        ...
        $form_content = new \FedExVendor\WPDesk\License\ActivationForm\Renderer($this->plugin_info);
