...
namespace FedExVendor\WPDesk\License\ActivationForm;

use FedExVendor\WPDesk\License\LicenseManager;
use FedExVendor\WPDesk\License\Page\LicensePageActions;
use FedExVendor\WPDesk\License\PluginLicense;
 ...
 */
class AjaxHandler implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_manager = new \FedExVendor\WPDesk\License\LicenseManager($this->plugin_info);
        ...
        $license_page_action = (new \FedExVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        $license_page_action->execute($plugin_info);
        $plugin_license = new \FedExVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \FedExVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $license_page_action->get_errors());
