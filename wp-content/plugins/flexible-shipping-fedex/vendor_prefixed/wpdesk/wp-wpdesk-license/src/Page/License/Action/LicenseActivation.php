 ...
 */
class LicenseActivation extends \FedExVendor\WPDesk\License\Page\License\Action\AbstractAction implements \FedExVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    {
        $this->add_error('api_key_check_text', 'api_key_check_error', \__('Connection failed to the Subscription Key API server. Try again later.', 'flexible-shipping-fedex'), 'error');
    }
    /**
    ...
    {
        $this->add_error('activate_text', 'activate_msg', \__('Plugin license activated. ', 'flexible-shipping-fedex') . "{$activate_results['message']}.", 'updated');
    }
    /**
     * Activate license.
     *
