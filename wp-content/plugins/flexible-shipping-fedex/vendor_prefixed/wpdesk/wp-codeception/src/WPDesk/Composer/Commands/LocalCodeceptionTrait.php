...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \FedExVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\FedExVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \FedExVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\FedExVendor\Symfony\Component\Console\Output\OutputInterface $output, \FedExVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\FedExVendor\Symfony\Component\Console\Output\OutputInterface $output, \FedExVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \FedExVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param bool            $coverage
     */
    private function installPlugin(string $plugin_dir, \FedExVendor\Symfony\Component\Console\Output\OutputInterface $output, \FedExVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, bool $coverage = \true)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \FedExVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\FedExVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \FedExVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
     ...
     */
    private function prepareLocalCodeceptionTests(\FedExVendor\Symfony\Component\Console\Input\InputInterface $input, \FedExVendor\Symfony\Component\Console\Output\OutputInterface $output, bool $coverage = \false)
    {
