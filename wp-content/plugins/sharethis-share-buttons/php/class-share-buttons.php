...
class Share_Buttons
{
    ...
    public function returnOmit()
    {
        ...
        $sharethis_sticky_category_off = get_option('sharethis_sticky_category_off', []);

        if (false === is_array($sharethis_sticky_category_off)) {
            $sharethis_sticky_category_off = [];
        }
        ...
        if ('category' === $post['type']) {
            ...
            foreach ($pages as $page) {
                 if (true === $this->notInList($page->ID)) {
                    $related[] = array(
                        'id'    => $page->ID,
    ...
    {
        $sharethis_sticky_page_off = get_option('sharethis_sticky_page_off', []);

        if (false === is_array($sharethis_sticky_page_off)) {
            $sharethis_sticky_page_off = [];
        }
