...
if ( !class_exists('FG_Magento_to_Woocommerce_ProgressBar', false) ) {
	 ...
	 */
	class FG_Magento_to_Woocommerce_ProgressBar {
		 ...
		 * @since    2.0.0
		 * 
		 * @param    FG_Magento_to_Woocommerce_Admin    $plugin       Admin plugin
		 */
