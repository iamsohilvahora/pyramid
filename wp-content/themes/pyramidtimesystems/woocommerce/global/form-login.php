...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		...
		<input type="email" class="input-text" autocapitalize="off" autocorrect="off" spellcheck="false" name="username" id="username" title="Email Address" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" required />
	</p>
